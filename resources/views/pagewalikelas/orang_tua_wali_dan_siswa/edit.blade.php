        ...
        <div class="page-content">
            ...
            <div class="row">
                <div class="col-xl-12 mx-auto">
                    <hr />
                    <form action="{{ route('orang-tua-wali-dan-siswa.update', $siswa->id) }}" method="POST" class="row g-3" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                                ...
                                <div class="card-body p-5">
                                    ...
                                    <div class="row g-3">
                                        <div class="col-12">
                                            ...
                                            <input type="text" class="form-control" id="nama_ortu" name="nama_ortu" value="{{ old('nama_ortu', $siswa->orangTuaWali->nama_ortu) }}" required>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" class="form-control" id="no_hp_ortu" name="no_hp_ortu" value="{{ old('no_hp_ortu', $siswa->orangTuaWali->no_hp_ortu) }}" required>
                                            <small class="text-danger">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="date" class="form-control" id="tanggal_lahir_ortu" name="tanggal_lahir_ortu" value="{{ old('tanggal_lahir_ortu', $siswa->orangTuaWali->tanggal_lahir_ortu) }}" required>
                                            <small class="text-danger">
                                        ...
                                        <div class="col-12">
                                            ...
                                            <textarea class="form-control" id="alamat_ortu" name="alamat_ortu" rows="3" required>{{ old('alamat_ortu', $siswa->orangTuaWali->alamat_ortu) }}</textarea>
                                            <small class="text-danger">
                                ...
                                <div class="card-body p-5">
                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="date" class="form-control" id="tanggal_lahir_siswa" name="tanggal_lahir_siswa" value="{{ old('tanggal_lahir_siswa', $siswa->tanggal_lahir_siswa) }}" required>
                                            <small class="text-danger">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="number" class="form-control" id="nisn_siswa" name="nisn_siswa" value="{{ old('nisn_siswa', $siswa->nisn_siswa) }}" maxlength="10" required>
                                            <small class="text-danger">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <select class="form-select" id="master_kelas_id" name="master_kelas_id" readonly>
                                                @foreach($masterKelas as $kelas)
                                                    <option value="{{ $kelas->id }}" {{ old('master_kelas_id', $siswa->master_kelas_id) == $kelas->id ? 'selected' : '' }}>
                                                        {{ $kelas->nama_kelas }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="col-12">
                                            ...
                                            <textarea class="form-control" id="alamat_siswa" name="alamat_siswa" rows="3" required>{{ old('alamat_siswa', $siswa->alamat_siswa) }}</textarea>
                                            <small class="text-danger">
