                        ...
                        <table id="example2" class="table table-striped table-bordered">
                            <thead>
                                <tr>
                                    ...
                                    <th>Tanggal Lahir Orang Tua/Wali</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $data->tanggal_lahir_siswa }}</td>
                                    <td>{{ $data->alamat_siswa }}</td>
                                    <td>{{ $data->masterKelas->nama_kelas }}</td>
                                    <td>{{ $data->nisn_siswa }}</td>
                                    <td>{{ $data->orangTuaWali->nama_ortu ?? '-' }}</td>
                                    <td>{{ $data->orangTuaWali->no_hp_ortu ?? '-' }}</td>
                                    <td>{{ $data->orangTuaWali->tanggal_lahir_ortu ?? '-' }}</td>
