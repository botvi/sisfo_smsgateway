                ...
                <div class="col-xl-7 mx-auto">
                    ...
                    <div class="card border-top border-0 border-4 border-primary">
                        <div class="card-body p-5">
                            ...
                            <hr>
                            <form action="{{ route('monitoring-absensi.kirimpesan') }}" method="POST" class="row g-3" enctype="multipart/form-data" id="kirimPesanForm">
                                @csrf
                                <div class="col-md-12">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.getElementById('kirimPesanForm').addEventListener('submit', function(e) {
        ...
        sendMessagesSequentially(Array.from(checkedSiswa), pesan);
    });
    
    function sendMessagesSequentially(siswaList, pesan) {
        ...
        function sendNext() {
            if (currentIndex >= totalSiswa) {
                ...
                setTimeout(() => {
                    window.location.href = '{{ route("monitoring-absensi.index") }}';
                }, 2000);
                return;
            }
            ...
            // Send message
            fetch('{{ route("monitoring-absensi.kirimpesan") }}', {
                method: 'POST',
                headers: {
